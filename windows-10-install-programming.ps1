...
Install-Software -path $programmingFolderPath -filename "*cmake*.zip" -extract $true -extract_location "$env:localappdata\Programs"
Rename-Item (Get-ChildItem $env:localappdata\Programs -Filter *cmake* | % { $_.FullName }) CMake
